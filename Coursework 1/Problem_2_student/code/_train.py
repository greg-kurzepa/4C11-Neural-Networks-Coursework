...
def train(model, loss_function, optimiser, train_dl, valid_dl, epochs, batch_size, dev, show_plot, log_wandb, clip_value=None, track_accuracy=False, accuracy_fn=None):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        for idx, (input, target) in enumerate(train_dl):
            ...
            epoch_correct = accuracy_fn(result, target)
            if track_accuracy: train_correct += epoch_correct
